...
export type * as TwinTestMath from './interfaces/twin-test-math.js'; // import twin:test/math
...
export * as stateful from './interfaces/twin-test-stateful.js'; // export twin:test/stateful
